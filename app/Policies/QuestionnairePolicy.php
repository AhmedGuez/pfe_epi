...
class QuestionnairePolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any Questionnaire');
    }
    ...
    {
        return $user->checkPermissionTo('view Questionnaire');
    }
    ...
    {
        return $user->checkPermissionTo('create Questionnaire');
    }
    ...
    {
        return $user->checkPermissionTo('update Questionnaire');
    }
    ...
    {
        return $user->checkPermissionTo('delete Questionnaire');
    }
