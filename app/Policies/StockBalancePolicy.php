...
class StockBalancePolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any StockBalance');
    }
    ...
    {
        return $user->checkPermissionTo('view StockBalance');
    }
    ...
    {
        return $user->checkPermissionTo('create StockBalance');
    }
    ...
    {
        return $user->checkPermissionTo('update StockBalance');
    }
    ...
    {
        return $user->checkPermissionTo('delete StockBalance');
    }
