...
class InterventionPolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any Intervention');
    }
    ...
    {
        return $user->checkPermissionTo('view Intervention');
    }
    ...
    {
        return $user->checkPermissionTo('create Intervention');
    }
    ...
    {
        return $user->checkPermissionTo('update Intervention');
    }
    ...
    {
        return $user->checkPermissionTo('delete Intervention');
    }
