...
class StockMovementPolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any StockMovement');
    }
    ...
    {
        return $user->checkPermissionTo('view StockMovement');
    }
    ...
    {
        return $user->checkPermissionTo('create StockMovement');
    }
    ...
    {
        return $user->checkPermissionTo('update StockMovement');
    }
    ...
    {
        return $user->checkPermissionTo('delete StockMovement');
    }
