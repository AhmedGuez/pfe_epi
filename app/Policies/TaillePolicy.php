...
class TaillePolicy
{
    ...
    {
        return $user->checkPermissionTo('view-any Taille');
    }
    ...
    {
        return $user->checkPermissionTo('view Taille');
    }
    ...
    {
        return $user->checkPermissionTo('create Taille');
    }
    ...
    {
        return $user->checkPermissionTo('update Taille');
    }
    ...
    {
        return $user->checkPermissionTo('delete Taille');
    }
